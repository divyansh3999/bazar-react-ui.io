        ...
        <OwlCarousel className="owl-theme productSlider" {...options}>
          <Box sx={{ boxShadow: "0px 0px 5px #a8b9bd", margin: "10px" }}>
            <UpperBox>
              ...
              <ProductImg className="productImage">
                <img
                  src="https://bazar-react.vercel.app/_next/image?url=%2Fassets%2Fimages%2FFurniture%20Shop%2FFurniture%20(1).png&w=1920&q=75"
                  alt=""
                />
              </ProductImg>
            </UpperBox>
          ...
          <Box sx={{ boxShadow: "0px 0px 5px #a8b9bd", margin: "10px" }}>
            <UpperBox>
              ...
              <ProductImg className="productImage">
                <img
                  src="https://bazar-react.vercel.app/_next/image?url=%2Fassets%2Fimages%2FFurniture%20Shop%2FFurniture%20(2).png&w=1920&q=75"
                  alt=""
                />
              </ProductImg>
            </UpperBox>
          ...
          <Box sx={{ boxShadow: "0px 0px 5px #a8b9bd", margin: "10px" }}>
            <UpperBox>
              ...
              <ProductImg className="productImage">
                <img
                  src="https://bazar-react.vercel.app/_next/image?url=%2Fassets%2Fimages%2FFurniture%20Shop%2FFurniture%20(3).png&w=1920&q=75"
                  alt=""
                />
              </ProductImg>
            </UpperBox>
          ...
          <Box sx={{ boxShadow: "0px 0px 5px #a8b9bd", margin: "10px" }}>
            <UpperBox>
              ...
              <ProductImg className="productImage">
                <img
                  src="https://bazar-react.vercel.app/_next/image?url=%2Fassets%2Fimages%2FFurniture%20Shop%2FFurniture%20(6).png&w=1920&q=75"
                  alt=""
                />
              </ProductImg>
            </UpperBox>
